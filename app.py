...
#
# Author: Gareth Cull
# This is a free and open source MCP server that helps data and marketing
# teams with pulling Google BigQuery data from the API.
...
def mcp_endpoint():
    ...
    if request_id is None:
        ...
        app.logger.info(f"Stateless notification received {method}")
        return ("", 204)
